...
export async function GET(
  ...
  try {
    ...
    // Nota: Para dados reais diários, o MCP server precisa ser atualizado
    // para suportar time_increment=1 na chamada da API da Meta
    const transformedInsights = dailyInsights.map((insight: any) => {
