...
- **Compile SDK**: 34
- **Java**: 17-19 (compatível com Gradle 8.5)

## ⚠️ Importante: Compatibilidade Java

O projeto está configurado para usar **Java 17**, que é compatível com Gradle 8.5.

### Se você tem Java 21 instalado:

**Opção 1: Configurar JDK 17 no Android Studio**
1. File → Project Structure → SDK Location
2. Em "Gradle Settings" → "Gradle JDK"
3. Selecione JDK 17 (ou baixe se necessário)

**Opção 2: Usar o JDK embutido do Android Studio**
1. File → Project Structure → SDK Location
2. Em "Gradle Settings" → "Gradle JDK"
3. Selecione "Embedded JDK" (geralmente é JDK 17)

### Tabela de Compatibilidade:

| Gradle Version | Min Java | Max Java |
|---------------|----------|----------|
| 8.5           | 8        | 19       |
| 8.1.1         | 8        | 19       |
| 9.0+          | 8        | 21       |
...
**Última Atualização**: 09/11/2025 (Compatibilidade Java)  
