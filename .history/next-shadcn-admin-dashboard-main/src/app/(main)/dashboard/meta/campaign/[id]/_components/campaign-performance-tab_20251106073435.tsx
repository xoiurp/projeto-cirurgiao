...
export function CampaignPerformanceTab({ campaign, insights }: CampaignPerformanceTabProps) {
  ...
  const performanceData = [
    { date: "01/11", impressions: 45, clicks: 3, spend: 0.42 },
    { date: "02/11", impressions: 52, clicks: 4, spend: 0.48 },
    { date: "03/11", impressions: 48, clicks: 2, spend: 0.38 },
    { date: "04/11", impressions: 61, clicks: 5, spend: 0.55 },
    { date: "05/11", impressions: 55, clicks: 4, spend: 0.51 },
    { date: "06/11", impressions: 58, clicks: 3, spend: 0.47 },
    { date: "07/11", impressions: 67, clicks: 6, spend: 0.66 },
  ];
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Evolução das métricas principais nos últimos 7 dias
          </CardDescription>
        </CardHeader>
        <CardContent>
